// apiPaths.js - FIXED VERSION
// export const BASE_URL = "https://job-portal-backend-lake-three.vercel.app/";
export const BASE_URL = "http://localhost:8000";

export const API_PATHS = {
  AUTH: {
    REGISTER: "api/auth/register",  // Removed leading slash
    LOGIN: "api/auth/login",        // Removed leading slash
